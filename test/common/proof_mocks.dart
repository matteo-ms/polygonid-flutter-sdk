...
class ProofMocks {
  ...
  /// [JWZProofEntity]
  static String jwzProofEntityJson = '''
  {
    "id": "1",
  ...
  static JWZProofEntity jwzProofEntity = JWZProofEntity.fromJson(jsonDecode(jwzProofEntityJson));
  ...
  static CircuitDataEntity circuitOnChainSigData =
  CircuitDataEntity(CommonMocks.circuitIdOnChainSig, datFile, zKeyFile);
